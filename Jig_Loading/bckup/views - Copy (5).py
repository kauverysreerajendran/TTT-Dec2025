...
class JigDetailsSaveAPIView(APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            available_capacity = jig_master.jig_capacity - faulty_slots - empty_slots
            ...
            total_loaded = total_cases_loaded + half_filled_sum

            # Calculate empty slots correctly
            jig_details_data['empty_slots'] = jig_master.jig_capacity - faulty_slots - total_loaded
